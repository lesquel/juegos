...
class TransferPaymentResponseDTO(TimeStampBase):
    ...
    transfer_state: TransferStateEnum = Field(..., description="Estado de la transferencia")
    transfer_description: Optional[str] = Field(None, description="Descripción opcional de la transferencia")

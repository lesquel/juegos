...
def get_all_games_use_case(
    ...
    return GetAllGamesUseCase(game_repo=game_repo, game_converter=game_converter)
...
def get_game_by_id_use_case(
    ...
    return GetGameByIdUseCase(game_repo=game_repo, game_converter=game_converter)
...
def get_games_by_category_id_use_case(
    ...
    return GetGamesByCategoryIdUseCase(
        game_repo=game_repo, game_converter=game_converter
    )

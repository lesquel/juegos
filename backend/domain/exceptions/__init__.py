...
class AuthenticationError(DomainException):
    ...
    def __init__(self, message: str = "Invalid credentials", identifier: str = "authentication_error"):
        super().__init__(message, 401, identifier)


class InvalidTokenError(DomainException):
    """Token inválido"""
    def __init__(self, message: str = "Invalid token", identifier: str = "invalid_token"):
        super().__init__(message, 401, identifier)


class ExpiredTokenError(DomainException):
    """Token expirado"""
    def __init__(self, message: str = "Token has expired", identifier: str = "expired_token"):
        super().__init__(message, 401, identifier)


class InsufficientPermissionsError(DomainException):
    """Permisos insuficientes"""
    def __init__(self, message: str = "Insufficient permissions", identifier: str = "insufficient_permissions"):
...
class UserAlreadyExistsError(DomainException):
    """Usuario ya existe"""
    def __init__(self, message: str = "User already exists", identifier: str = "user_already_exists"):
        super().__init__(message, 409, identifier)


class UserNotFoundError(DomainException):
    """Usuario no encontrado"""
    def __init__(self, message: str = "User not found", identifier: str = "user_not_found"):
        super().__init__(message, 404, identifier)


class InsufficientFundsError(DomainException):
    """Fondos insuficientes"""
    def __init__(self, message: str = "Insufficient funds", identifier: str = "insufficient_funds"):
...
class GameNotFoundError(DomainException):
    """Juego no encontrado"""
    def __init__(self, message: str = "Game not found", identifier: str = "game_not_found"):
        super().__init__(message, 404, identifier)


class GameAlreadyExistsError(DomainException):
    """Juego ya existe"""
    def __init__(self, message: str = "Game already exists", identifier: str = "game_already_exists"):
        super().__init__(message, 409, identifier)
...
class CategoryNotFoundError(DomainException):
    ...
    def __init__(self, message: str = "Category not found", identifier: str = "category_not_found"):
        super().__init__(message, 404, identifier)


class CategoryAlreadyExistsError(DomainException):
    """Categoría ya existe"""
    def __init__(self, message: str = "Category already exists", identifier: str = "category_already_exists"):
        super().__init__(message, 409, identifier)
...
class MatchNotFoundError(DomainException):
    ...
    def __init__(self, message: str = "Match not found", identifier: str = "match_not_found"):
        super().__init__(message, 404, identifier)


class MatchAlreadyFinishedError(DomainException):
    """Partida ya terminada"""
    def __init__(self, message: str = "Match has already finished", identifier: str = "match_already_finished"):
        super().__init__(message, 400, identifier)


class MatchNotStartedError(DomainException):
    """Partida no iniciada"""
    def __init__(self, message: str = "Match has not started yet", identifier: str = "match_not_started"):
        super().__init__(message, 400, identifier)


class AlreadyParticipatingError(DomainException):
    """Ya está participando en la partida"""
    def __init__(self, message: str = "User is already participating in this match", identifier: str = "already_participating"):
        super().__init__(message, 409, identifier)
...
class TransferNotFoundError(DomainException):
    ...
    def __init__(self, message: str = "Transfer not found", identifier: str = "transfer_not_found"):
        super().__init__(message, 404, identifier)


class InvalidTransferStateError(DomainException):
    """Estado de transferencia inválido"""
    def __init__(self, message: str = "Invalid transfer state", identifier: str = "invalid_transfer_state"):
        super().__init__(message, 400, identifier)
...
class ConcurrencyError(DomainException):
    ...
    def __init__(self, message: str = "Resource was modified by another process", identifier: str = "concurrency_error"):
        super().__init__(message, 409, identifier)

...
class GameEntityToDTOConverter(EntityToDTOConverter[GameEntity, GameResponseDTO], LoggingMixin):
    ...
    def to_dto(self, entity: GameEntity) -> GameResponseDTO:
        """Convierte GameEntity a GameResponseDTO."""
        self.logger.debug(f"Converting GameEntity to GameResponseDTO for game: {entity.game_id}")
        ...
        try:
            ...
            if entity.categories:
                for category in entity.categories:
                    ...
                    elif hasattr(category, 'category_id'):  # Es una entidad CategoryEntity
            ...
            self.logger.error(f"Error converting GameEntity to GameResponseDTO: {str(e)}")
            raise
    


class GameBidirectionalConverter(BidirectionalConverter[GameEntity, GameResponseDTO], LoggingMixin):
    ...
    def to_dto(self, entity: GameEntity) -> GameResponseDTO:
        """Convierte GameEntity a GameResponseDTO."""
        self.logger.debug(f"Converting GameEntity to GameResponseDTO (bidirectional) for game: {entity.game_id}")
        ...
        try:
            ...
            self.logger.debug("Successfully converted GameEntity to GameResponseDTO (bidirectional)")
            return dto
    ...
    def to_entity(self, dto: GameResponseDTO) -> GameEntity:
        ...
        self.logger.debug(f"Converting GameResponseDTO to GameEntity for game: {dto.game_id}")

"""
Conversor de TransferPaymentEntity a TransferPaymentResponseDTO.
"""
...
class TransferPaymentEntityToDTOConverter(EntityToDTOConverter[TransferPaymentEntity, TransferPaymentResponseDTO], LoggingMixin):
    ...
    def to_dto(self, entity: TransferPaymentEntity) -> TransferPaymentResponseDTO:
        ...
        try:
            ...
            self.logger.debug("Successfully converted TransferPaymentEntity to TransferPaymentResponseDTO")
            return dto
            
        except Exception as e:
            self.logger.error(f"Error converting TransferPaymentEntity to DTO: {str(e)}")
            raise

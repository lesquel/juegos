...
from .transfer_payment_response_to_entity_converter import TransferPaymentResponseToEntityConverter



class TransferPaymentBidirectionalConverter(BidirectionalConverter[TransferPaymentEntity, TransferPaymentResponseDTO], LoggingMixin):
    ...
    def to_dto(self, entity: TransferPaymentEntity) -> TransferPaymentResponseDTO:
        ...
        """
        self.logger.debug(f"Converting TransferPaymentEntity to TransferPaymentResponseDTO for transfer: {entity.transfer_id}")
    ...
    def from_request_dto(
        ...
        return self.dto_to_entity.convert_with_context(dto, user_id, transfer_id, transfer_state)

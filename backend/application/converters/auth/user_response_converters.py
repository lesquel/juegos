...
class UserEntityToDTOConverter(EntityToDTOConverter[UserEntity, UserResponseDTO], LoggingMixin):
    ...
    def to_dto(self, entity: UserEntity) -> UserResponseDTO:
        ...
        try:
            ...
            self.logger.error(f"Error converting UserEntity to UserResponseDTO: {str(e)}")
            raise
    

class UserEntityToBaseResponseDTOConverter(EntityToDTOConverter[UserEntity, UserBaseResponseDTO], LoggingMixin):
    ...
    def to_dto(self, entity: UserEntity) -> UserBaseResponseDTO:
        ...
        self.logger.debug(f"Converting UserEntity to UserBaseResponseDTO for user: {entity.user_id}")
        ...
        try:
            ...
            self.logger.debug("Successfully converted UserEntity to UserBaseResponseDTO")
            return dto
            
        except Exception as e:
            self.logger.error(f"Error converting UserEntity to UserBaseResponseDTO: {str(e)}")
            raise

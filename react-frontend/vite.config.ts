...
export default defineConfig({
  ...
  define: {
    'import.meta.env.VITE_API_URL_DEV': JSON.stringify(process.env.VITE_API_URL_DEV || 'http://localhost:8080'),
    'import.meta.env.VITE_API_URL_PROD': JSON.stringify(process.env.VITE_API_URL_PROD || 'https://juegos-backend-mot1.onrender.com'),
    'import.meta.env.VITE_BASE_URL': JSON.stringify(process.env.VITE_BASE_URL || 'http://localhost:8080'),

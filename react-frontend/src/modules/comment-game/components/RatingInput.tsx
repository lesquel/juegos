        ...
        <div className="flex items-center gap-4">
          ...
          >
            {stars.map((star) => {
              ...
              return (
                <label key={star} className="cursor-pointer p-1 rounded">
                  <input
                    type="radio"
                    name="rating"
                    value={star}
                  ...
                  />
                  <StarIcon
                    className="w-6 h-6 text-yellow-400 hover:text-yellow-300 hover:scale-110 transition-all duration-200"

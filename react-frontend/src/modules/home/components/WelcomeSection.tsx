  ...
  return (
    ...
    >
      ...
      <div className="relative bg-white/5 backdrop-blur-sm border border-white/20 rounded-3xl p-10 sm:p-14 md:p-16 lg:p-20 xl:p-24 shadow-2xl space-y-12 sm:space-y-16 lg:space-y-20">
        <h2
          id="welcome-heading"
          className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold leading-tight space-y-3 sm:space-y-4 lg:space-y-6"
        >
        ...
        <div className="bg-white/5 backdrop-blur-sm border border-white/20 rounded-2xl p-8 sm:p-10 md:p-12 lg:p-16 xl:p-20 shadow-lg">
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl text-gray-200 leading-relaxed max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-2 sm:space-y-3">
        ...
        <div className="bg-gradient-to-r from-cyan-500/10 via-purple-500/10 to-pink-500/10 backdrop-blur-sm border border-cyan-400/30 rounded-2xl p-8 sm:p-10 lg:p-12 xl:p-16 shadow-lg">
          <span className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl bg-gradient-to-r from-cyan-400 to-pink-400 bg-clip-text text-transparent font-bold block px-4 sm:px-6 py-2 sm:py-3">
            🎮 ¡Tu juego ayuda! 💜
          </span>
        </div>
      </div>

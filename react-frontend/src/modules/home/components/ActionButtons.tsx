...
const ActionButtons: React.FC = memo(() => {
  ...
  return (
    <div className="flex flex-col sm:flex-row gap-6 justify-center items-center w-full max-w-lg mx-auto">
      <Link
        to={loginUrl}
        className="group relative w-full sm:w-auto flex-1 text-center bg-gradient-to-r from-cyan-500 via-blue-500 to-purple-500 text-white font-bold py-4 px-8 rounded-2xl shadow-2xl hover:shadow-cyan-500/25 focus:outline-none focus:ring-2 focus:ring-cyan-400/50 transition-all duration-500 ease-out transform hover:scale-105 flex items-center justify-center gap-3 overflow-hidden"
      ...
      <Link
        to={registerUrl}
        className="group relative w-full sm:w-auto flex-1 text-center bg-gradient-to-r from-purple-500 via-pink-500 to-rose-500 text-white font-bold py-4 px-8 rounded-2xl shadow-2xl hover:shadow-purple-500/25 focus:outline-none focus:ring-2 focus:ring-purple-400/50 transition-all duration-500 ease-out transform hover:scale-105 flex items-center justify-center gap-3 overflow-hidden"

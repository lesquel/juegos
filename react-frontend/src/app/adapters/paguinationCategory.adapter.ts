...
import type { 
  PaginationMatch
 } from "@modules/games/models/pagination-match";
...
export class PaginationCategoryAdapter {
   ...
   */
  static adaptPaginationCategory(paguination: PaginationCategory): string {
    const params: Record<string, any> = {
      ...
      ...(paguination.category_name && {
        category_name: paguination.category_name,
      }),
      ...(paguination.category_description && {
        category_description: paguination.category_description,
      }),
      ...(paguination.status && { status: paguination.status }),
      // Parámetros de fechas
      ...(paguination.created_before && {
        created_before: paguination.created_before,
      }),
      ...(paguination.created_after && {
        created_after: paguination.created_after,
      }),
    };
   ...
   */
  static adaptPaginationGames(paguination: PaginationGames): string {
    const params: Record<string, any> = {
      page: paguination.page,
      limit: paguination.limit,
      // Parámetros de ordenamiento
   ...
   */
  static adaptPaginationMatch(paguination: PaginationMatch): string {
    const params: Record<string, any> = {
      page: paguination.page,
      limit: paguination.limit,
      // Parámetros de ordenamiento
      ...
      ...(paguination.min_base_bet_amount && {
        min_base_bet_amount: paguination.min_base_bet_amount,
      }),
      ...(paguination.max_base_bet_amount && {
        max_base_bet_amount: paguination.max_base_bet_amount,
      }),
      // Parámetros de fechas
      ...(paguination.created_before && {
        created_before: paguination.created_before,

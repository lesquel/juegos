...
export const CardTransfer: React.FC<CardTransferProps> = memo(({ transfer }) => {
  ...
  const statusBadge = useMemo(() => {
    ...
    const className = statusClasses[transfer.transfer_state as keyof typeof statusClasses] || defaultClass;
      ...
      >
        ...
        <div className="space-y-2">
          ...
          <footer className="flex justify-between items-center pt-3 border-t border-gray-600">
            <time className="text-gray-400 text-xs" dateTime={transfer.created_at}>
              {formattedDate}
            </time>

...
const WelcomeSection: React.FC = memo(() => {
  return (
    <section className="text-center max-w-3xl mx-auto" aria-labelledby="welcome-heading">
      <h2 
        id="welcome-heading"
      ...
      <p className="text-gray-300 md:text-lg leading-relaxed">
        Este proyecto, creado por estudiantes de 4º nivel de Ingeniería de Software de la ULEAM, 

...
const UseListGames = memo(() => {
  const [pagination, setPagination] = useState<PaguinationGames>(DEFAULT_PAGINATION);
  ...
  const handlePaginationChange = useCallback((newPagination: PaguinationGames) => {
...
const GamesContent = memo(({ pagination, onPaginationChange }: {

...
const ListGamesContent = ({ activeTab, setActiveTab }: ListGamesContentProps) => {
    const [paginationOffline, setPaginationOffline] = useState<PaginationGames>(DEFAULT_PAGINATION);
    const [paginationOnline, setPaginationOnline] = useState<PaginationGames>(DEFAULT_PAGINATION);
    ...
    const handleSearch = useCallback((filters: SearchFilters) => {
        const newPagination = {
            ...
            ...(filters.filterType === "game_name" && { game_name: filters.searchTerm }),
            ...(filters.filterType === "game_description" && { game_description: filters.searchTerm }),

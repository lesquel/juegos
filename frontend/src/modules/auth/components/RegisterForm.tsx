...
const UseRegisterForm = () => {
  ...
  return (
    <div className="w-full px-4 max-w-sm sm:max-w-md mx-auto">
      ...
      <div className="relative w-36 h-36 rounded-full bg-green-500 flex items-center justify-center overflow-hidden mb-3 mx-auto">
        <img
      ...
      <p className="text-sm text-gray-500 mb-3 border-b border-gray-300 pb-1 text-center">
